...
class Candidate(Base):
    ...
    federal_constituency = Column(String(255), nullable=True)
    provincial_constituency = Column(String,nullable = True)
    ...
    # Image
    image = Column(String(500), nullable=True, comment="Store image URL")
